...
const fieldClass =
  'h-11 w-full appearance-none rounded-xl border border-line bg-surface ps-3 pe-9 text-sm text-ink transition-colors duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink/20 disabled:opacity-40'
